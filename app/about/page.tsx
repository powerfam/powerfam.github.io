  ...
  return (
    <div className="max-w-4xl mx-auto w-full text-left">
      ...
      <div className="space-y-4 text-base md:text-lg leading-relaxed mb-12">
        <p>저는 인생의 정답보다는 오답들을 피해가는 연습을 열심히 하는 사람입니다.</p>
        <p>두 살배기 딸을 키우면서, 배우고 생각하고 정리한 것을 딸이 성인이 되었을 때 남겨주고 싶어 블로그를 시작했습니다.</p>
        <p>Voti(보티)는 핀란드어 기원으로 &quot;승리&quot;, &quot;극복하다&quot;라는 뜻을 가지고 있습니다.</p>
      </div>
